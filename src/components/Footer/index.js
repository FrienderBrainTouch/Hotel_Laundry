...
const Footer = () => {
  return (
    <footer className="w-full">
      ...
      <div className="bg-[#082567] h-[300px] xs:h-[264px] sm:h-[215px] md:h-[171px] lg:h-[215px] xl:h-[250px] 2xl:h-[250px] w-full flex items-center justify-center">
      ...
      <div className="bg-white h-[175px] xs:h-[145px] w-full flex items-center justify-center">
        {/* 텍스트 영역 - 2XL 기준 1400px 제한 */}
