      ...
      <div className="w-full xs:max-w-[355px] sm:max-w-[535px] md:max-w-[728px] lg:max-w-[924px] xl:max-w-[1200px] 2xl:max-w-[1400px] mx-auto">
        ...
        <div className="mb-[20px] sm:mb-[25px] md:mb-[30px] lg:mb-[40px] xl:mb-[40px] 2xl:mb-[50px]">
          ...
          <div className="text-center mb-10">
            <h1 
              className="mb-8 text-[22px] sm:text-[24px] md:text-[28px] lg:text-[32px] xl:text-[36px] 2xl:text-[40px] font-bold leading-normal text-center text-[#1C262B] font-['KoPubWorldDotum'] tracking-[-0.44px] sm:tracking-[-0.48px] md:tracking-[-0.56px] lg:tracking-[-0.64px] xl:tracking-[-0.72px] 2xl:tracking-normal"
            >
              {/* xs (기본) - 간단한 문구 */}
              ...
              <span className="hidden sm:inline">IoT와 AI로 더 똑똑해진 프리미엄 세탁 시스템</span>
                         ...
                         {/* 부제목 */}
             <div 
               className="text-center mx-auto text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] xl:text-[24px] font-light leading-normal text-[#1C262B] font-['KoPubWorldDotum']"
             >
               {/* xs (기본) - 간단한 문구 */}
