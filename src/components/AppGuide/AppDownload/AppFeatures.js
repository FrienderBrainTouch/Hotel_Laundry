...
const AppFeatures = () => {
  const features = [
    ...
    },
    {
      icon: "🔔",
      title: "실시간 알림",
      description: "세탁 진행 상황을 실시간으로 알려드립니다",
      details: [
        "픽업 완료 알림",
        "세탁 시작 알림",
        "세탁 완료 알림",
    ...
    },
    {
      icon: "📍",
      title: "매장 찾기",
      description: "내 주변 호텔런드리 매장을 쉽게 찾아보세요",
      details: [
        "GPS 기반 위치 검색",
        "매장별 운영시간",
        "실시간 대기 상황",
    ...
    },
    {
      icon: "📊",
      title: "이용 내역",
      description: "세탁 이력과 통계를 한눈에 확인하세요",
      details: [
        "세탁 이력 관리",
        "월별 통계",
        "비용 분석",
    ...
    },
    {
      icon: "🎯",
      title: "맞춤 서비스",
      description: "개인별 선호도에 맞는 서비스를 제공합니다",
      details: [
        "개인 설정 저장",
        "자주 이용하는 매장",
        "선호 세탁 옵션",
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-24 font-['KoPubWorldDotum'] text-[#1C262B] max-w-3xl mx-auto">
            호텔런드리 앱의 다양한 기능으로 더욱 편리한 세탁 서비스를 경험하세요
          </p>
        </div>
