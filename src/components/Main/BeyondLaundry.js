  ...
  const gridItems = [
    {
      title: "모바일 세탁 예약 서비스",
      subtitle: {
        xs: "• 스마트폰 앱을 통해 원하는 시간에\n세탁기를 미리 예약\n\n• 실시간 장비 현황 확인으로 대기 없이\n편리하게 이용 가능",
        sm: "• 스마트폰 앱을 통해 원하는 시간에 세탁기를 미리 예약\n\n• 실시간 장비 현황 확인으로 대기 없이 편리하게 이용 가능",
        md: "• 스마트폰 앱을 통해 원하는 시간에\n세탁기를 미리 예약\n\n• 실시간 장비 현황 확인으로 대기 없이\n편리하게 이용 가능",
        lg: "• 스마트폰 앱을 통해 원하는 시간에\n세탁기를 미리 예약\n\n• 실시간 장비 현황 확인으로 대기 없이\n편리하게 이용 가능",
        xl: "• 스마트폰 앱을 통해 원하는 시간에\n세탁기를 미리 예약\n\n• 실시간 장비 현황 확인으로 대기 없이\n편리하게 이용 가능",
        "2xl": "• 스마트폰 앱을 통해 원하는 시간에 세탁기를 미리 예약\n\n• 실시간 장비 현황 확인으로 대기 없이\n편리하게 이용 가능"
      },
    ...
    },
    {
      ...
      subtitle: {
        ...
        sm: "• 시간대별 차등가격 쿠폰 제공과 포인트 적립\n\n• 카드, 모바일, 포인트 결제까지 다양한 방식으로 자유롭게\n결제 가능한 무인 시스템",
        md: "• 시간대별 차등가격 쿠폰 제공과\n포인트 적립\n\n• 카드, 모바일, 포인트 결제까지 다양한\n방식으로 자유롭게 결제 가능한 무인 시스템",
        lg: "• 시간대별 차등가격 쿠폰 제공과\n포인트 적립\n\n• 카드, 모바일, 포인트 결제까지 다양한\n방식으로 자유롭게 결제 가능한 무인 시스템",
        xl: "• 시간대별 차등가격 쿠폰 제공과\n포인트 적립\n\n• 카드, 모바일, 포인트 결제까지 다양한\n방식으로 자유롭게 결제 가능한 무인 시스템",
        "2xl": "• 시간대별 차등가격 쿠폰 제공과 포인트 적립\n\n• 카드, 모바일, 포인트 결제까지 다양한 방식으로\n자유롭게 결제 가능한 무인 시스템"
      },
    ...
    },
    {
      ...
      subtitle: {
        xs: "• 유해물질, 발암물질이 없는 친환경\n드라이클리닝 방식\n\n• 고객이 직접 쉽고 간단하게 이용할 수 있는\n셀프 서비스",
        sm: "• 유해물질, 발암물질이 없는 친환경 드라이클리닝 방식\n\n• 고객이 직접 쉽고 간단하게 이용할 수 있는 셀프 서비스",
        md: "• 유해물질, 발암물질이 없는 친환경\n드라이클리닝 방식\n\n• 고객이 직접 쉽고 간단하게 이용할 수 있는\n셀프 서비스",
        lg: "• 유해물질, 발암물질이 없는 친환경\n드라이클리닝 방식\n\n• 고객이 직접 쉽고 간단하게 이용할 수 있는\n셀프 서비스",
        xl: "• 유해물질, 발암물질이 없는 친환경\n드라이클리닝 방식\n\n• 고객이 직접 쉽고 간단하게 이용할 수 있는\n셀프 서비스",
        "2xl": "• 유해물질, 발암물질이 없는 친환경 드라이클리닝 방식\n\n• 고객이 직접 쉽고 간단하게 이용할 수 있는\n셀프 서비스"
      },
    ...
    },
    {
      ...
      subtitle: {
        xs: "• 전 코스 프리미엄 살균수로 항균세탁이\n기본 제공\n\n• 고사양 장비로 짧은 시간에도\n우수한 세탁 품질 보장",
        sm: "• 전 코스 프리미엄 살균수로 항균세탁이 기본 제공\n\n• 고사양 장비로 짧은 시간에도 우수한 세탁 품질 보장",
        md: "• 전 코스 프리미엄 살균수로 항균세탁이\n기본 제공\n\n• 고사양 장비로 짧은 시간에도\n우수한 세탁 품질 보장",
        lg: "• 전 코스 프리미엄 살균수로 항균세탁이\n기본 제공\n\n• 고사양 장비로 짧은 시간에도\n우수한 세탁 품질 보장",
        xl: "• 전 코스 프리미엄 살균수로 항균세탁이\n기본 제공\n\n• 고사양 장비로 짧은 시간에도\n우수한 세탁 품질 보장",
        "2xl": "• 전 코스 프리미엄 살균수로 항균세탁이\n기본 제공\n\n• 고사양 장비로 짧은 시간에도 우수한 세탁 품질 보장"
      },
    ...
    },
    {
      ...
      subtitle: {
        xs: "• 고객 문의, 장비 점검 요청 등\n모든 문제 신속 대응\n\n• 24시간 운영으로 언제든지\n고객 지원 서비스 이용 가능",
        sm: "• 고객 문의, 장비 점검 요청 등 모든 문제 신속 대응\n\n• 24시간 운영으로 언제든지 고객 지원 서비스 이용 가능",
        md: "• 고객 문의, 장비 점검 요청 등\n모든 문제 신속 대응\n\n• 24시간 운영으로 언제든지\n고객 지원 서비스 이용 가능",
        lg: "• 고객 문의, 장비 점검 요청 등\n모든 문제 신속 대응\n\n• 24시간 운영으로 언제든지\n고객 지원 서비스 이용 가능",
        xl: "• 고객 문의, 장비 점검 요청 등\n모든 문제 신속 대응\n\n• 24시간 운영으로 언제든지\n고객 지원 서비스 이용 가능",
        "2xl": "• 고객 문의, 장비 점검 요청 등 모든 문제 신속 대응\n\n• 24시간 운영으로 언제든지\n고객 지원 서비스 이용 가능"
      },
    ...
    },
    {
      ...
      subtitle: {
        xs: "• 본사에서 전국 매장을 원격 제어하며\n운영 안정성 확보\n\n• 실시간 모니터링으로 긴급 상황 발생 시\n즉시 대응",
        sm: "• 본사에서 전국 매장을 원격 제어하며 운영 안정성 확보\n\n• 실시간 모니터링으로 긴급 상황 발생 시 즉시 대응",
        md: "• 본사에서 전국 매장을 원격 제어하며\n운영 안정성 확보\n\n• 실시간 모니터링으로 긴급 상황 발생 시\n즉시 대응",
        lg: "• 본사에서 전국 매장을 원격 제어하며\n운영 안정성 확보\n\n• 실시간 모니터링으로 긴급 상황 발생 시\n즉시 대응",
        xl: "• 본사에서 전국 매장을 원격 제어하며\n운영 안정성 확보\n\n• 실시간 모니터링으로 긴급 상황 발생 시\n즉시 대응",
        "2xl": "• 본사에서 전국 매장을 원격 제어하며\n운영 안정성 확보\n\n• 실시간 모니터링으로 긴급 상황 발생 시 즉시 대응"
      },
  ...
  useEffect(() => {
    const interval = setInterval(() => {
      setCurrentSlide((prev) => {
        if (window.innerWidth < 768) { // sm 576px 미만 (xs)
          if (prev >= 5) { // 6개 아이템 (0-5)
            return 0;
          }
          return prev + 1;
        } else { // sm 576px 이상
          if (prev >= 2) { // 6개 아이템 (0-5) - 수정된 부분
            return 0;
          }
          return prev + 1;
        }
