  ...
  const gridItems = [
    {
      ...
      subtitle: {
        xs: [
          '이불 세탁과 양복 드라이클리닝이 하나의 세탁기에서 모두 가능합니다.',
          '세탁소나 크린토**를 위협하는 가장 강력한 매출 극대화를 기대합니다.',
    ...
    },
    {
      ...
      subtitle: {
        xs: [
          '장비 사용 중 발생하는 다양한 고객의 민원과 문제점을 매장 방문없이 원격으로 해결합니다.',
    ...
    },
    {
      ...
      subtitle: {
        xs: [
          '새벽 시간이나 중요한 미팅 또는 영화 한편 맘 편히 볼 수 없는 고객 전화는 가장 큰 스트레스 입니다.',
    ...
    },
    {
      ...
      subtitle: {
        xs: [
          '4차 산업 시대에 가장 중요한 빅데이터를 활용하여 고객 맞춤형 관리 시스템을 적용합니다.',
    ...
    },
    {
      ...
      subtitle: {
        xs: [
          '정부 지원 고객 반응도 조사 결과 1위는 위생 입니다.',
          '모든 세탁, 헹굼 과정에서 자동 투입하는 Hocl 살균수는',
