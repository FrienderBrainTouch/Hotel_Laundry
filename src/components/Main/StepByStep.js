...
const StepByStep = () => {
  ...
  const steps = [
    {
      image: `${ASSET_URL}/images/main-Images/main-step-1.png`,
      title: '상담 및 상권 분석',
      subtitle: '창업 문의 후, 희망 지역에 대한 상권·입지 분석 제공',
      subtitleMd: '창업 문의 후, 희망 지역에 대한\n상권·입지 분석 제공',
    },
    {
      image: `${ASSET_URL}/images/main-Images/main-step-2.png`,
      title: '계약 및 공간 설계',
      subtitle: '가맹 계약 체결 후, 매장 실측 기반의 3D 설계 진행',
      subtitleMd: '가맹 계약 체결 후,\n 매장 실측 기반의 3D 설계 진행',
    },
    {
      image: `${ASSET_URL}/images/main-Images/main-step-3.png`,
      title: '장비 설치 및 교육',
      subtitle: 'IoT 장비 및 키오스크 설치, 점주 대상 운영 교육 진행',
      subtitleMd: 'IoT 장비 및 키오스크 설치,\n 점주 대상 운영 교육 진행',
    },
    {
      image: `${ASSET_URL}/images/main-Images/main-step-4.png`,
      title: '마케팅 지원 + 오픈 운영',
          ...
          {steps.map((step, index) => (
            <div key={index} className="w-full">
              ...
              <div className="md:hidden w-full mb-8">
                ...
                <div
                  className="w-[275px] h-[100px] xs:w-[355px] xs:h-[100px] sm:w-[535px] sm:h-[120px] mx-auto p-3 sm:p-4"
                  style={{ backgroundColor: '#1022540D' }}
                >
                  <h3
              ...
              >
                ...
                {/* Content */}
                <div
                  className="w-[275px] h-[180px] xs:w-[365px] xs:h-[180px] lg:w-[495px] lg:h-[200px] xl:w-[600px] xl:h-[230px] 2xl:w-[700px] 2xl:h-[300px] flex flex-col justify-end p-5 lg:p-4 xl:p-5 2xl:p-8"
                  style={{ backgroundColor: '#1022540D' }}
                >
