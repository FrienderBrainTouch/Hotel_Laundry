    ...
    <section className="w-full py-20 bg-white">
      ...
      <div className="mb-10">
        <div className="container mx-auto px-4 text-center">
          <h2 className="text-[40px] font-medium text-[#1C262B] mb-4" style={{ fontFamily: 'KoPubWorldBatang' }}>
            Why Hotel Laundry
          </h2>
          <p className="text-[32px] font-medium text-[#1C262B]" style={{ fontFamily: 'KoPubWorldDotum' }}>
            이런 고민, 해본 적 있나요?
          </p>
        </div>
      </div>
      ...
      <div className="mb-10">
        <div className="flex items-center justify-center">
          <picture className="w-full h-[430px] object-cover opacity-15">
            ...
            <img 
              ...
              className="w-full h-[430px] object-cover opacity-15"
            />
          </picture>
        </div>
      </div>
      ...
      <div>
        <div className="px-4 text-center">
          <div className="w-full">
            <p className="text-[24px] font-medium text-[#1C262B] mb-4" style={{ fontFamily: 'KoPubWorldDotum' }}>
              이제는 매장을 <span className="font-medium">'직접 운영'</span>하는 시대가 아닙니다.
            </p>
            <p className="text-[24px] font-medium text-[#1C262B]" style={{ fontFamily: 'KoPubWorldDotum' }}>
              고객 응대, 운영, 마케팅, 본사 관리까지 호텔런드리는{' '}
