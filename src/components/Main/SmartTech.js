    ...
    <section className="py-8 md:py-12 lg:py-16 bg-white">
      <div className="px-4 ">
        ...
        <div className="relative max-w-[96rem] mx-auto">
          ...
          <button
            onClick={() => handleManualSlide('prev')}
            className="sm:hidden absolute left-1/2 transform -translate-x-1/2 bottom-4 z-10 hover:opacity-80 transition-opacity duration-200"
            aria-label="이전 슬라이드"
          >
          ...
          <button
            onClick={() => handleManualSlide('next')}
            className="sm:hidden absolute left-1/2 transform -translate-x-1/2 bottom-4 ml-16 z-10 hover:opacity-80 transition-opacity duration-200"
            aria-label="다음 슬라이드"
          >
          ...
          {/* Slide Container */}
          <div className="relative overflow-hidden mx-24 lg:mx-24 md:mx-8 sm:mx-4">
            <div 
            ...
            >
              {slides.map((slide, index) => (
                ...
                >
                  ...
                  {/* Mobile Layout (md, sm, xs) */}
                  <div className="lg:hidden relative w-[355px] h-[330px] sm:w-[480px] sm:h-[360px] md:w-[620px] md:h-[410px] ml-[25px] sm:ml-[16px]">
                    {/* Background Image */}
                    <div className="absolute inset-0 w-[355px] h-[226px] sm:w-[480px] sm:h-[226px] md:w-[620px] md:h-[250px] rounded-[15px] sm:rounded-[18px] md:rounded-[20px] overflow-hidden">
                      <img 
                        src={slide.image} 
                        alt={`Smart Tech Slide ${slide.id}`}
                        className="w-full h-full object-cover"
                    ...
                    <div 
                      className="absolute bottom-[10px] left-0 right-0 z-20 p-10 bg-white w-[355px] h-[130px] sm:w-[480px] sm:h-[150px] md:w-[620px] md:h-[200px] shadow-[3px_6px_10px_-5px_rgba(16,34,84,0.15)]"
                      style={{
                    ...
                    >
                      <h3 
                        className="text-[#1C262B] font-['KoPubWorldDotum'] text-[16px] sm:text-[18px] md:text-[20px] font-normal font-[700] mb-2"
                        style={{ fontWeight: 700 }}
                      >
                        {slide.title}
                      </h3>
                      <p 
                        className="text-[#1C262B] font-['KoPubWorldDotum'] text-[14px] sm:text-[16px] md:text-[18px] font-normal font-[500] whitespace-pre-line"
                        style={{ fontWeight: 500 }}
                      >
                        {slide.subtitle}
                      </p>
