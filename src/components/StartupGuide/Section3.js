...
const Section3 = () => {
  return (
    <section className="bg-white py-10 sm:py-16 md:py-24 px-4 font-sans">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="text-center mb-10 sm:mb-16 md:mb-24">
          ...
          <p className="mt-3 section-subtitle text-gray-500">
        ...
        <div className="space-y-12 sm:space-y-16 md:space-y-20 xl:space-y-28">
          ...
          <div className="flex flex-col md:flex-row md:items-stretch overflow-hidden rounded-xl sm:rounded-2xl md:rounded-[20px] shadow-[5px_7px_11px_1px_rgba(164,198,224,0.25)]">
            ...
            <div className="w-full md:w-3/5 order-2 md:order-2 bg-white">
              <div className="h-full flex flex-col justify-center p-5 sm:p-6 md:p-8">
                <h3 className="section-title font-bold text-gray-800 mb-4">무인세탁 시장의 폭발적 성장</h3>
          ...
          <div className="flex flex-col md:flex-row md:items-stretch overflow-hidden rounded-xl sm:rounded-2xl md:rounded-[20px] shadow-[5px_7px_11px_1px_rgba(164,198,224,0.25)]">
            ...
            <div className="w-full md:w-3/5 order-2 md:order-1 bg-white">
              <div className="h-full flex flex-col justify-center p-5 sm:p-6 md:p-8">
                <h3 className="section-title font-bold text-gray-800 mb-4">고객이 느끼는 불편과 한계</h3>
                <ul className="space-y-2 text-24 text-gray-600 list-disc list-inside">
          ...
          <div className="flex flex-col md:flex-row md:items-stretch overflow-hidden rounded-xl sm:rounded-2xl md:rounded-[20px] shadow-[5px_7px_11px_1px_rgba(164,198,224,0.25)]">
            ...
            <div className="w-full md:w-3/5 bg-white">
              <div className="h-full flex flex-col justify-center p-5 sm:p-6 md:p-8">
                <h3 className="section-title font-bold text-gray-800 mb-4">운영 효율 향상 시뮬레이션 결과</h3>
                <ul className="space-y-2 text-24 text-gray-600 list-disc list-inside">
