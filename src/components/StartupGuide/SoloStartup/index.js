                    ...
                    <div className="bg-white rounded-2xl shadow-xl overflow-hidden">
                      <div className="aspect-video bg-gray-900 relative">
                        <iframe
                          width="100%"
                          height="100%"
                          src="https://www.youtube.com/embed/aqt5o-1ViGY?si=OT-PitYAknqvRhxO&amp;start=141"
                      ...
                      <div className="p-8">
                        ...
                        <p className="text-24 text-gray-600 mb-6">
                          25년간의 회사 생활을 마치고 은퇴한 안영준씨가 3개 매장을 운영하며 경험한
                          실제 성공 사례를 확인해보세요.
                        </p>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-16">
                    ...
                    <div className="bg-gradient-to-br from-green-50 to-emerald-50 rounded-xl p-6 shadow-lg hover:shadow-xl transition-shadow">
                      ...
                      <ul className="space-y-2">
                        ...
                        <li className="text-xs text-gray-500 flex items-center">
                          <span className="w-1.5 h-1.5 bg-green-400 rounded-full mr-2"></span>월
                          1300만원 이상 수익
                        </li>
                        <li className="text-xs text-gray-500 flex items-center">
                          <span className="w-1.5 h-1.5 bg-green-400 rounded-full mr-2"></span>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-gray-500 mt-4">
                          "25년간의 회사 생활을 마치고 은퇴 후 창업했는데, 크게 힘들이지 않고
                          안정적인 수익을 얻을 수 있어서 만족합니다."
                        </p>
                      </div>
                    </div>
                    ...
                    <div className="bg-white rounded-xl p-6 shadow-lg">
                      ...
                      <div className="space-y-3">
                        ...
                        <p className="text-sm text-gray-500 mt-4">
                          "신규 매장도 두 달 만에 월 매출 800만원을 달성했습니다. 본사에서 위탁
                          운영을 해주어 관리 부담이 거의 없어요."
                        </p>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-white rounded-2xl p-8 shadow-xl">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                      ...
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-600">
                          고객 문의(CS), 청소, 세제 교체 등 대부분의 관리를 본사에서 대신
                          처리해줍니다
                        </p>
                      </div>
                      <div className="text-center">
                        ...
                        <p className="text-sm text-gray-600">
                          고객은 스마트폰 앱으로 빈 세탁기를 확인하고 예약하며, 세탁 완료 시 알림을
                          받습니다
                        </p>
                      </div>
                    </div>
