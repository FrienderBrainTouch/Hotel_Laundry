      ...
      <div className="container mx-auto">
        <div className="w-full xs:max-w-[355px] sm:max-w-[535px] md:max-w-[728px] lg:max-w-[924px] xl:max-w-[1200px] 2xl:max-w-[1400px] mx-auto">
          ...
          <div className="text-center mb-[20px] sm:mb-[30px] md:mb-[20px] lg:mb-[30px] xl:mb-[30px] 2xl:mb-[30px]">
            ...
            <div className="text-center mx-auto text-[18px] sm:text-[20px] md:text-[22px] lg:text-[24px] xl:text-[28px] 2xl:text-[32px] font-light leading-normal text-[#1C262B] font-KoPubWorldDotum tracking-[-0.36px] sm:tracking-[-0.4px] md:tracking-[-0.44px] lg:tracking-[-0.48px] xl:tracking-[-0.64px] 2xl:tracking-[-0.64px]">
          ...
          <div className="space-y-12 sm:space-y-16 md:space-y-20 xl:space-y-28">
            ...
            <div className="flex flex-col md:flex-row md:items-stretch overflow-hidden rounded-xl sm:rounded-2xl md:rounded-[20px] shadow-[5px_7px_11px_1px_rgba(164,198,224,0.25)]">
              ...
              <div className="relative w-full md:w-2/5 order-1 md:order-1 bg-[#A4C6E0] p-3 sm:p-4">
                <span className="absolute -top-10 -right-4 text-5xl xs:text-6xl sm:text-7xl md:text-8xl font-black text-gray-100 -z-10">
                  01
                </span>
                <img
                  src={`${ASSET_URL}/image/bar2.svg`}
            ...
            <div className="flex flex-col md:flex-row md:items-stretch overflow-hidden rounded-xl sm:rounded-2xl md:rounded-[20px] shadow-[5px_7px_11px_1px_rgba(164,198,224,0.25)]">
              ...
              <div className="relative w-full md:order-2 md:w-2/5 bg-[#A4C6E0] p-3 sm:p-4">
                <span className="absolute -top-10 -left-4 text-5xl xs:text-6xl sm:text-7xl md:text-8xl font-black text-gray-100 -z-10">
                  02
                </span>
                <img
                  src={`${ASSET_URL}/image/circle2.svg`}
                  alt="고객 불편 사항 원형 그래프"
                  className="block w-full h-auto object-contain max-h-48 xs:max-h-56 sm:max-h-64 md:max-h-none"
                />
              </div>
            ...
            <div className="flex flex-col md:flex-row md:items-stretch overflow-hidden rounded-xl sm:rounded-2xl md:rounded-[20px] shadow-[5px_7px_11px_1px_rgba(164,198,224,0.25)]">
              ...
              <div className="relative w-full md:w-2/5 bg-[#A4C6E0] p-3 sm:p-4">
                ...
                <img
                  src={`${ASSET_URL}/image/line_chart2.svg`}
                  alt="시간대별 사용률 라인 그래프"
                  className="block w-full h-auto object-contain max-h-48 xs:max-h-56 sm:max-h-64 md:max-h-none"
                />
              </div>
