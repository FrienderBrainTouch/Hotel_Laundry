      ...
      <div className="px-4 lg:px-6 py-4">
        <div className="flex items-center justify-between">
          <div className="flex items-center space-x-2 lg:space-x-3">
            ...
            />
            <h1
              className="text-lg lg:text-2xl font-bold text-brand-blue cursor-pointer"
              onClick={() => navigate('/admin/dashboard')}
            >
              호텔런드리 관리자
            </h1>
          ...
          <div className="flex items-center space-x-2 lg:space-x-4">
            ...
            <button
              ...
              className="bg-brand-blue hover:bg-brand-dark text-white px-3 lg:px-4 py-2 rounded-md text-xs lg:text-sm font-medium transition-colors"
            >
              로그아웃
            </button>
          </div>
